...
class TestAccountInterface:
    ...
    def test_login(self):
        ...
        assert account_itf.login('username', 'test', '123456') == {'msg': 'succesfully login!',
                                                                   'info': self.select_test_result}
    ...
    def test_update_info(self):
        assert account_itf.update_info(0, gender='空', age=0, email='空',
                                       signature='这个人很懒，什么也没有写~') == 'failed to identify, please check your accout and try again.'
        assert account_itf.update_info(1, gender='空', age=0, email='空',
                                       signature='这个人很懒，什么也没有写~') == 'success to update info.'
